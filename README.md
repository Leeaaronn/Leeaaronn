...
I build data systems that solve real problems. Currently, Data & Technology Analyst @ATC, where I noticed operations running on paper and whiteboards. So I built a [dashboard](https://github.com/Leeaaronn/Tutoring-Ops-Dashboard) to fix that.
Most recently, I [analyzed the City of Toronto's fleet and ferry data](https://github.com/Leeaaronn/Toronto-anchored-City-of-Toronto-Fleet-Ferry-Performance-Dashboard), benchmarking 4,600+ vehicles against the Auditor General's targets in a Power BI dashboard.
